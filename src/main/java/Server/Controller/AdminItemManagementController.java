...
public class AdminItemManagementController {
    ...
    private Node createItemCard(Item item) {
        ...
        Label description = new Label(nullToText(item.getDescription(), "Không có mô tả"));
        ...
        Label owner = new Label("Người bán #" + item.getOwner_user_id());
        ...
        meta.getChildren().addAll(id, owner, minStep, note);
